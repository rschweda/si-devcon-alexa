...
public class HelpIntentHandler implements RequestHandler {
    ...
    public Optional<Response> handle(HandlerInput handlerInput) {
        ...
        Image img =  Image.builder().withLargeImageUrl("https://img.fotocommunity.com/kaputte-fenster-die-3-0c5a6da5-9105-4040-9d0d-1a9f35d4eb57.jpg?height=1080").build();
